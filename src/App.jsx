...
function App() {
  ...
  const [resgistrationSuccess, setResgistrationSuccess] = useState(false)
  ...
  const handleSubmit = (e) => {
    ...
    if(newAlerts.firstName === '' && newAlerts.lastName === '' && newAlerts.email === '' && newAlerts.phoneNumber === ''){
      setResgistrationSuccess(true)
    }
  }
      ...
      <div className='container'>
        <div className="App">
          {resgistrationSuccess && (
            <div className='success' style={{backgroundColor: 'blue', color : 'white', padding: '10px', marginTop: '10px', borderRadius:'5px', textAlign:'center', width : '20vw', height: '3.5vw', fontSize: '1.3rem'}}>
